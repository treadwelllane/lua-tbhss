  ...
  local function sample (o_modeler, o_classifier)
    ...
    if not has_modeler then
      modeler.create(db, {
        ...
        tmin = o_modeler.tmin,
        ttc = o_modeler.ttc,
        sentences = (not o_modeler.supervision) and fs.join(dir, name_modeler .. ".train.sentences.txt") or nil,
        samples = (o_modeler.supervision) and fs.join(dir, name_modeler .. ".train.samples.txt") or nil,
        supervision = o_modeler.supervision,
