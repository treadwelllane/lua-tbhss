...
cmd_create_bitmaps_auto_encoded:option("--drop-clause", "Tsetlin Machine drop clause", 0.75, tonumber, 1, "0-1")
cmd_create_bitmaps_auto_encoded:option("--scale-loss", "scale for triplet loss", nil, tonumber, 1, 1)
cmd_create_bitmaps_auto_encoded:option("--scale-loss-max", "max for triplet loss", 0, tonumber, 1, "0-1")
cmd_create_bitmaps_auto_encoded:option("--scale-loss-min", "min for triplet loss", 1, tonumber, 1, "0-1")
...
cmd_create_bitmaps_encoded:option("--drop-clause", "Tsetlin Machine drop clause", 0.75, tonumber, 1, "0-1")
cmd_create_bitmaps_encoded:option("--scale-loss", "scale for triplet loss", nil, tonumber, 1, 1)
cmd_create_bitmaps_encoded:option("--scale-loss-max", "max for triplet loss", 0, tonumber, 1, "0-1")
cmd_create_bitmaps_encoded:option("--scale-loss-min", "min for triplet loss", 1, tonumber, 1, "0-1")
